...
public class SecurityConfig extends UserContextConfiguration {
    ...
    public SecurityFilterChain filterChain(
        ...
        return http
                .securityMatcher(allowToStartWorkflowsViaRestUnauthenticated())
    ...
    /**
     * All endpoints are secured. For easy usage of this Blueprint the REST endpoint for initiating
     * a new loan approval workflow is not secured. In a real world scenario this endpoint would be
     * secured using the same chain if the workflow is started by a user or secured using a
     * separate chain if the workflow is started by a another service.
     *
