...
public class BlueprintUserService {
     ...
     */
    public UserDetailsImpl getUser(final String userId) {
     ...
     */
    private UserDetailsImpl toUser(UserRepresentation user) {
        if (user == null) {
            return null;
        }
        ...
        return new UserDetailsImpl(
                ...
                display,
                displayShort,
                user.getGroups() != null ? user.getGroups() : new ArrayList<>()
        );
    }
}